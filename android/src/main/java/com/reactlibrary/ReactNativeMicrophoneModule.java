// ReactNativeMicrophoneModule.java
...
public class ReactNativeMicrophoneModule extends ReactContextBaseJavaModule {
    ...
    public ReactNativeMicrophoneModule(ReactApplicationContext reactContext) {
        super(reactContext);
